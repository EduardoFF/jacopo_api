#ifndef _LCMHANDLER_H_
#define _LCMHANDLER_H_
...
public:
	...
	void publish(const map<UInt8, Node> nodeList, UInt64 timestamp);
	/**
	 ...
	 */
	void setLCMMessageFromNodeList(map<UInt8, Node> listAllNodes,
